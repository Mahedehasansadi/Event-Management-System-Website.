...
if(isset($_POST['submit']))
{
	...
	$sql="insert into tblpbooking(BookingID,PackageID,Name,MobileNumber,Email,EventDate,EventStartingtime,EventEndingtime,VenueAddress,AdditionalInformation)values(:bookingid,:bid,:name,:mobnum,:email,:edate,:est,:eetime,:vaddress,:addinfo)";
...
<html lang="en">
<head>
	<title>Decoration Management System - Package booking</title>
	<meta charset="utf-8">
		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-end">
				<div class="col-md-9 ftco-animate pb-5">
					<p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right"></i></a></span> <span>Package Booking <i class="fa fa-chevron-right"></i></span></p>
					<h1 class="mb-0 bread">Book Package</h1>
				</div>
			</div>
		</div>
	</section>
					...
					<div class="wrapper">
						<div class="row no-gutters">
							...
							<div class="col-md-5 d-flex align-items-stretch">
								<div class="info-wrap w-100 p-5 img" style="background-image: url(images/eventpromotion.webp);">
								</div>
							</div>
						</div>
					</div>
