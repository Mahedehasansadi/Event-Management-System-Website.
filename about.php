		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-end">
				<div class="col-md-9 ftco-animate pb-5">
					<p class="breadcrumbs mb-2" style="font-family: 'Great Vibes', cursive;"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right"></i></a></span> <span style="font-family: 'Great Vibes', cursive;">About us <i class="fa fa-chevron-right"></i></span></p>
					<h1 class="mb-0 bread" style="font-family: 'Great Vibes', cursive;">About Us</h1>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="col-md-6 pl-md-5 pt-md-5">
					<div class="row justify-content-start py-5">
						<div class="col-md-12 heading-section ftco-animate">
							...
							<h2 class="mb-4" style="font-family: 'Great Vibes', cursive;">Let's make your Event Beautiful than ever</h2>
		...
		<div class="container" style="height: 100px;">
			<div class="row justify-content-center">
				<div class="col-md-8 text-center mt-4">
					<h2 style="font-family: 'Great Vibes', cursive;">Together we will explore new Event!!!</h2>
				</div>
			</div>
		</div>
	</section>
