            ...
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                ...
                <div class="modal-body" id="info_update4">
                 <?php @include("view_newpbooking.php");?>
               </div>
        ...
        if(isset($_POST['search']) & !empty($_POST['fromdate']))
        {
          ...
          <div class="table-responsive p-3">
            ...
            <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
              ...
              <tbody>
                <?php
                $sql="SELECT * from tblpbooking where date( BookingDate) between '$fdate' and '$tdate'";
                    ...
                    {               ?>
                      <tr>
                        ...
                        <td class=" text-center"><a href="#"  class=" edit_data4" id="<?php echo  ($row->ID); ?>" title="click to edit"><i class="mdi mdi-eye" aria-hidden="true"></i></a>
                          <a href="invoice_pgeneration.php?invid=<?php echo htmlentities ($row->ID);?>"><i class="mdi mdi-printer" aria-hidden="true"></i></a>
                        </td>
                      </tr>
                      <?php
                      $cnt=$cnt+1;
            ...
            <div class="table-responsive p-3">
              <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
               ...
               <tbody>
                <?php
                $sql="SELECT * from tblpbooking ORDER BY ID DESC";
                $query = $dbh -> prepare($sql);
                $query->execute();
                $results=$query->fetchAll(PDO::FETCH_OBJ);
