                  ...
                  if($query->rowCount() > 0)
                  {
                    ...
                    { 
                      ...
                      <table  border="1" class="table align-items-center table-bordered table-hover">
                        ...
                        <tr>
                          <th style="text-align: center;" colspan="2">Package Name</th>
                          <th style="text-align: center;" colspan="2">Package Price</th>
                        </tr>
                        <tr>
                          <td style="text-align: center;" colspan="2"><?php  echo $row->PackageName;?></td>
                          <td style="text-align: center;" colspan="2"><?php  echo $total= $row->PackagePrice;?></td>
