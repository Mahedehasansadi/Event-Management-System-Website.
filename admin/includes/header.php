 <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
    <a class="navbar-brand brand-logo " href="dashboard.php"><img class="img-avatar" style="height: 60px; width: 60px;" src="companyimages/OIP.jpg" alt=""></a>
      ...
      <li class="nav-item nav-profile dropdown">
        ...
        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
          ...
          <li class="nav-item dropdown">
            <?php 
            $sql ="SELECT ID from tblbooking where Status is null  ORDER BY id DESC ";
            $query = $dbh -> prepare($sql);
            $query->execute();
            $results=$query->fetchAll(PDO::FETCH_OBJ);
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <div class="dropdown-divider"></div>
              <?php
              $sql ="SELECT * from tblbooking where Status is null order by ID DESC LIMIT 3";
              $query = $dbh -> prepare($sql);
              $query->execute();
              $results=$query->fetchAll(PDO::FETCH_OBJ);
              $totalnewbooking=$query->rowCount();
          ...
          <li class="nav-item dropdown">
            <?php 
            $sql ="SELECT ID from tblpbooking where Status is null  ORDER BY id DESC ";
            $query = $dbh -> prepare($sql);
            $query->execute();
            $results=$query->fetchAll(PDO::FETCH_OBJ);
            $totalnewbooking=$query->rowCount();
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <div class="dropdown-divider"></div>
              <?php
              $sql ="SELECT * from tblpbooking where Status is null order by ID DESC LIMIT 3";
              $query = $dbh -> prepare($sql);
              $query->execute();
              $results=$query->fetchAll(PDO::FETCH_OBJ);
              $totalnewbooking=$query->rowCount();
              ...
              <?php } ?>
              <div class="dropdown-divider"></div>
              <h6 class="p-3 mb-0 text-center"> <a href="new_pbooking.php">See all new bookings</a></h6>
            </div>
          </li>
