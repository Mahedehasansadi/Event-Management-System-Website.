 <nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="manage_package.php">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="new_bookings.php">New Service Bookings</a></li>
                    <li class="nav-item"> <a class="nav-link" href="new_pbooking.php">New Package Bookings</a></li>
                    <li class="nav-item"> <a class="nav-link" href="approved_bookings.php">Approved Service Bookings</a></li>
                    <li class="nav-item"> <a class="nav-link" href="approved_packagebookings.php">Approved Package Bookings</a></li>
                    <li class="nav-item"> <a class="nav-link" href="cancelled_bookings.php">Cancelled Service Bookings</a></li>
                    <li class="nav-item"> <a class="nav-link" href="cancelled_packagebookings.php">Cancelled Package Bookings</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="reports">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="booking_report.php">Service Booking reports</a></li>
                    <li class="nav-item"> <a class="nav-link" href="pbooking_report.php">Package Booking reports</a></li>
                    <li class="nav-item"> <a class="nav-link" href="btndates_report.php">Btndates Reports</a></li>
                    <li class="nav-item"> <a class="nav-link" href="btnpdates_report.php">Btndates Package Reports</a></li>
                </ul>
            </div>
        </li>
    </ul>
